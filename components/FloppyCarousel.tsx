...
const projects = [
    { title: "Neon Studio", description: "A modern web application showcasing neon-themed design elements and interactive animations.", tech: "React • Three.js • Tailwind CSS", color: 65535, url: "https://neon-studio.example.com", github: "https://github.com/bohselecta/neon-studio" },
    { title: "XR Landing", description: "An immersive landing page for XR experiences featuring spatial design and interactive elements.", tech: "Next.js • WebXR • Three.js", color: 16711935, url: "https://xr-landing.example.com", github: "https://github.com/bohselecta/xr-landing" },
    { title: "Gummy Brand", description: "Complete brand identity system for a confectionery company with playful animations and vibrant colors.", tech: "Figma • After Effects • Illustrator", color: 65280, url: "https://gummy-brand.example.com", github: "https://github.com/bohselecta/gummy-brand" },
    { title: "AI Chat Interface", description: "A sleek chat interface powered by AI with real-time message streaming and voice input capabilities.", tech: "React • Node.js • OpenAI API", color: 16776960, url: "https://ai-chat.example.com", github: "https://github.com/bohselecta/ai-chat" },
    { title: "Data Visualization", description: "Interactive data visualization dashboard with real-time updates and customizable chart types.", tech: "D3.js • WebGL • Python", color: 16737792, url: "https://data-viz.example.com", github: "https://github.com/bohselecta/data-viz" },
    { title: "Mobile App Design", description: "Complete mobile app design system with custom components and micro-interactions.", tech: "Figma • Swift • Kotlin", color: 65535, url: "https://mobile-app.example.com", github: "https://github.com/bohselecta/mobile-app" },
    { title: "Web Platform", description: "A comprehensive web platform with user authentication, dashboard, and API integration.", tech: "Next.js • TypeScript • PostgreSQL", color: 16711782, url: "https://web-platform.example.com", github: "https://github.com/bohselecta/web-platform" },
    { title: "Creative Tools", description: "A suite of creative tools for designers including color palette generators and asset libraries.", tech: "Vue.js • Node.js • MongoDB", color: 6684927, url: "https://creative-tools.example.com", github: "https://github.com/bohselecta/creative-tools" },
